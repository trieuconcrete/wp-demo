...
a)}})});
jQuery(".td-debug-area").length&&(jQuery.ajax({type:"POST",url:td_ajax_url,data:{_nonce:window.tdb_globals.wpRestNonce,action:"tdb_work_cloud",option:"get"},success:function(a,b,c){b="";a=JSON.parse(a);"undefined"!==typeof a[0].checked&&(b=a[0].checked);jQuery(".td-debug-area").append('<table id="td-log1-table" class="widefat td-system-status-table td-log-table" cellspacing="0"><tbody><tr><td><p>Enable/disable WORK-CLOUD</p></td></tr><tr><td><div class="td-admin-checkbox td-small-checkbox"><input type="checkbox" class="td-work-cloud" '+b+
"></div></td></tr></tbody></table>")},error:function(a,b,c){}}),jQuery("body").on("click",".td-work-cloud",function(){var a=jQuery(this);jQuery.ajax({type:"POST",url:td_ajax_url,data:{_nonce:window.tdb_globals.wpRestNonce,action:"tdb_work_cloud",option:"set",value:a.attr("checked")},success:function(a,c,e){window.location.reload()},error:function(a,c,e){}})}));
