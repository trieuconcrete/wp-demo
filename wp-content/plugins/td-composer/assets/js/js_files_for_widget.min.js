...
k(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");k(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(b){if(-1!==b.indexOf("[caption")){var e=/\[caption(.*)\](.*)\[\/caption\]/g.exec(b);3===e.length&&(b=e[2])}var f=k("img",b).attr("src");e="";"undefined"===typeof f?(f=k(b).attr("src"),e=k(b).attr("class")):e=k("img",b).attr("class");k.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id","uuid="+tdcJobManager._getUniqueID()),
beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_class:e,action:"tdc_ajax_get_image_id"}}).done(function(b,e,h){if("success"===e)if(a.isObject(b)&&a.has(b,"errors"))new tdcNotice.notice(b.errors,!0,!1);else{e=c.closest(".tdc-property-wrap");h=e.find(".tdc-css-image-remove");var g=e.find(".tdc-inherit-image");h.removeClass("tdc-hidden-button");"all"===tdcSidebar.currentViewportSettings.name?g.hide():g.show();c.attr("style","background-image: url( '"+
...
d.hasClass("tdc-box-border")||d.hasClass("tdc-box-padding")||(f=c.closest(".tdc-property-wrap"));d=c.val();var h=1;c.hasClass("tdc-css-opacity")&&(h=.01);var l=NaN;switch(b.type){case "keyup":switch(b.keyCode){case 38:k.isNumeric(d)&&(l=parseFloat(d)+h);break;case 40:k.isNumeric(d)&&(l=parseFloat(d)-h)}break;case "mousewheel":b.preventDefault(),b.stopImmediatePropagation(),k.isNumeric(d)&&(l=0<b.originalEvent.deltaY?parseFloat(d)-h:parseFloat(d)+h)}a.isNaN(l)||(1>h&&(l=l.toFixed(2)),c.val(l));tdcCssEditor._updateData(c);
...
f=tdcCssEditor._generateCssAttValue(f),tdcSidebarController.onUpdate(a,c,"",f))},saveWidgetForm:function(a){var b=a.closest("form");a=a.closest(".tdc-tab-content");if(b.length){var c=b.find('input[name="id_base"]').val(),f=b.find('input[name="widget-id"]').val().replace(c+"-","");c="'widget-"+c+"["+f+"][tdc_css]'";f=b.find("input[name="+c+"]");var h=tdcCssEditor._generateCssAttValue(a);a.data("tdc_css",h);f.length?f.val(h):b.append('<input type="hidden" name='+c+' value="'+h+'">')}},addWidgetCssEditor:function(a,
...
c;else try{var e=JSON.parse(window.atob(b));tdcDebug.log(e);a.isObject(e)?tdcCssEditor._currentCssSettings=e:tdcCssEditor._currentCssSettings=c}catch(d){tdcCssEditor._currentCssSettings=c,new tdcNotice.notice(d.message,!1,!1)}tdcSidebarPanel._hook.addAction("panel_rendered",function(){k(".tdc-css-image-wrap").each(function(b,e){b=k(e);e=b.closest(".tdc-property-wrap");var d=e.find(".tdc-css-image-remove"),f=e.find(".tdc-inherit-image"),n={isInherited:!1},g=tdcCssEditor._getSettingsProperty("background-image",
c,n);n.isInherited?e.addClass(tdcCssEditor._INHERITED_CSS_CLASS):e.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);a.isUndefined(g)?(d.addClass("tdc-hidden-button"),f.hide()):("no_value"===g?d.addClass("tdc-hidden-button"):(d.removeClass("tdc-hidden-button"),b.attr("style",'background-image: url("'+g+'")')),"all"!==tdcSidebar.currentViewportSettings.name&&f.show());b.data("image_link",g)});k(".tdc-inherit").each(function(b,e){b=k(e);e=b.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||
...
tdcCssEditor._getRgba(c.attr("placeholder"))):("no_value"===c.val()&&c.val(""),tdcCssEditor._checkDefaultColor(c))})},generateEditorResponsiveContent:function(){function b(){return n={isInherited:!1}}function e(a){return"all"!==tdcSidebar.currentViewportSettings.name?'placeholder="'+a+'"':""}function d(){return n.isInherited?" "+tdcCssEditor._INHERITED_CSS_CLASS:""}function f(c,e){e=tdcCssEditor._getSettingsProperty(c,e,b());var f="-",g="";n.isInherited&&(f=e,e="");a.isUndefined(l)||"margin-left"!==
c&&"margin-right"!==c||(g=l.get("tag"),g="vc_column"===g||"vc_column_inner"===g?" "+tdcCssEditor._INACTIVE_CSS_CLASS:"");return'<input data-tdc-for="'+c+'" name="" type="text" value="'+e+'" class="tdc-css-box-input tdc-css-box-input-'+c+d()+g+'" title="Css '+c+'" placeholder="'+f+'" '+tdcSidebarPanel._getParamterDataAtts(h,l)+"/>"}tdcSidebarPanel._hook.removeAction("panel_css");var h=tdcCssEditor._mappedParameter,l=tdcCssEditor._model,n={isInherited:!1};var g='<div class="tdc-responsiveness"><div class="'+
(tdcSidebarPanel._getParameterClasses(h)+'">');g=g+'<div class="tdc-box-margin"><div class="tdc-margin-label">Margin</div>'+f("margin-top","");g+=f("margin-right","");g+=f("margin-bottom","");g+=f("margin-left","");g=g+'<div class="tdc-box-border"><div class="tdc-border-label">Border</div>'+f("border-top-width","");g+=f("border-right-width","");g+=f("border-bottom-width","");g+=f("border-left-width","");g=g+'<div class="tdc-box-padding"><div class="tdc-padding-label">Padding</div>'+f("padding-top",
"");g+=f("padding-right","");g+=f("padding-bottom","");g+=f("padding-left","");g+="</div></div></div></div>";var m=tdcCssEditor._getSettingsProperty("border-style",c,b());g+='<div class="tdc-property-wrap tdc-border-style tdc-dropdown-big'+d()+'" data-tdc-for="border-style">';g=g+'<div class="tdc-property-title"><span title="Css border-style" class="tdc-search-data">Border style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-border-style" '+
...
m);g+="</select></div></div>";m=a.uniqueId();var p=tdcCssEditor._getSettingsProperty("border-color","",b()),q="";n.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-border-color'+d()+'" data-tdc-for="border-color">';g=g+'<div class="tdc-property-title"><span title="Css border-color" class="tdc-search-data">Border color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-border-color" '+tdcSidebarPanel._getParamterDataAtts(h,l)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+m+'" name="" type="text" '+e(q)+' value="'+p+'"/>');g+="</div></div>";m=tdcCssEditor._getSettingsProperty("border-radius","",b());p="";n.isInherited&&(p=m,m="");g+='<div class="tdc-property-wrap tdc-border-radius tdc-textfield-small'+d()+'" data-tdc-for="border-radius">';g=g+'<div class="tdc-property-title"><span title="Css border-radius" class="tdc-search-data">Border radius</span></div><div class="tdc-property"><input class="tdc-css-border-radius" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+e(p)+' value="'+m+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';m=tdcCssEditor._getSettingsProperty("width","",b());p="";n.isInherited&&(p=m,m="");g+='<div class="tdc-property-wrap tdc-width tdc-textfield-big'+d()+'" data-tdc-for="width">';g=g+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Width</span></div><div class="tdc-property"><input class="tdc-css-width" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+e(p)+' value="'+m+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';m=tdcCssEditor._getSettingsProperty("shadow-size","",b());p="";n.isInherited&&(p=m,m="");g+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+d()+'" data-tdc-for="shadow-size">';g=g+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Shadow size</span></div><div class="tdc-property"><input class="tdc-css-shadow-size" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+e(p)+' value="'+m+'"/>');g+="</div></div>";m=a.uniqueId();p=tdcCssEditor._getSettingsProperty("shadow-color","",b());q="";n.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-shadow-color'+d()+'" data-tdc-for="shadow-color">';g=g+'<div class="tdc-property-title"><span title="Css shadow-color" class="tdc-search-data">Shadow color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-shadow-color" '+tdcSidebarPanel._getParamterDataAtts(h,l)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+m+'" name="" type="text" '+e(q)+' value="'+p+'"/>');g+="</div></div>";m=tdcCssEditor._getSettingsProperty("shadow-offset-h","",b());p="";n.isInherited&&(p=m,m="");g+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+d()+'" data-tdc-for="shadow-offset-h">';g=g+'<div class="tdc-property-title"><span title="Css shadow-offset-h" class="tdc-search-data">Shadow offset H</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-h" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+e(p)+' value="'+m+'"/>');g+="</div></div>";m=tdcCssEditor._getSettingsProperty("shadow-offset-v","",b());p="";n.isInherited&&(p=m,m="");g+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+d()+'" data-tdc-for="shadow-offset-v">';g=g+'<div class="tdc-property-title"><span title="Css shadow-offset-v" class="tdc-search-data">Shadow offset V</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-v" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+e(p)+' value="'+m+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';m=a.uniqueId();p=tdcCssEditor._getSettingsProperty("background-color","",b());q="";n.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-bg-color'+d()+'" data-tdc-for="background-color">';g=g+'<div class="tdc-property-title"><span title="Css background-color" class="tdc-search-data">Background color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-bg-color" '+tdcSidebarPanel._getParamterDataAtts(h,l)+tdcCssEditor._getDataNoValue(p)+' id="'+m+'" name="" type="text" '+e(q)+' value="'+p+'"/>');g+="</div></div>";tdcCssEditor._getSettingsProperty("background-image",c,b());g+='<div class="tdc-property-wrap tdc-property-attach_image'+d()+'">';g=g+'<div class="tdc-property-title"><span title="Css background-image" class="tdc-search-data">Background image<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-image"></div></span></div><div class="tdc-property"><div class="tdc-css-bg-image tdc-css-image-wrap " '+
...
"</select></div></div>";m=tdcCssEditor._getSettingsProperty("opacity","",b());p="";n.isInherited&&(p=m,m="");g+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+d()+'" data-tdc-for="opacity">';g=g+'<div class="tdc-property-title"><span title="Css background-image opacity" class="tdc-search-data">Background opacity</span></div><div class="tdc-property"><input class="tdc-css-opacity" '+(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+e(p)+' value="'+m+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';
m=a.uniqueId();p=tdcCssEditor._getSettingsProperty("color-1-overlay","",b());q="";n.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-1-overlay'+d()+'" data-tdc-for="color-1-overlay">';g=g+'<div class="tdc-property-title"><span title="Css gradient color From" class="tdc-search-data">Color 1 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-1-overlay" '+tdcSidebarPanel._getParamterDataAtts(h,l)+tdcCssEditor._getDataNoValue(p)+' id="'+m+'" name="" type="text" '+e(q)+' value="'+p+'"/>');g+="</div></div>";m=a.uniqueId();p=tdcCssEditor._getSettingsProperty("color-2-overlay","",b());q="";n.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-2-overlay'+d()+'" data-tdc-for="color-2-overlay">';g=g+'<div class="tdc-property-title"><span  title="Css gradient color To" class="tdc-search-data">Color 2 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-2-overlay" '+tdcSidebarPanel._getParamterDataAtts(h,l)+tdcCssEditor._getDataNoValue(p)+' id="'+m+'" name="" type="text" '+e(q)+' value="'+p+'"/>');g+="</div></div>";m=tdcCssEditor._getSettingsProperty("gradient-direction","",b());p="";n.isInherited&&(p=m,m="");g+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+d()+'" data-tdc-for="gradient-direction">';g=g+'<div class="tdc-property-title"><span title="Css gradient direction" class="tdc-search-data">Gradient direction</span></div><div class="tdc-property"><input class="tdc-css-gradient-direction" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+e(p)+' value="'+m+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';m=tdcCssEditor._getSettingsProperty("content-h-align",c,b());g+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+d()+'" data-tdc-for="content-h-align">';g=g+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">H. align<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-content-h-align" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="">');g+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Default"},{value:"content-horiz-left",display:"Left"},{value:"content-horiz-center",display:"Center"},{value:"content-horiz-right",display:"Right"}],m);g+="</select></div></div>";"vc_row"!==l.get("tag")&&"vc_row_inner"!==l.get("tag")&&"vc_column"!==l.get("tag")&&"vc_column_inner"!==l.get("tag")&&(m=tdcCssEditor._getSettingsProperty("order","",b()),p="",n.isInherited&&(p=m,m=""),g+=
'<div class="tdc-property-wrap tdc-order tdc-textfield-small'+d()+'" data-tdc-for="order">',g=g+'<div class="tdc-property-title"><span title="Order" class="tdc-search-data">Order</span></div><div class="tdc-property"><input class="tdc-css-order" '+(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+e(p)+' value="'+m+'"/>'),g+="</div></div>");m=tdcCssEditor._getSettingsProperty("z-index","",b());p="";n.isInherited&&(p=m,m="");g+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+
d()+'" data-tdc-for="z-index">';g=g+'<div class="tdc-property-title"><span title="Z-index" class="tdc-search-data">Z-index</span></div><div class="tdc-property"><input class="tdc-css-z-index" '+(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+e(p)+' value="'+m+'"/>');g+="</div></div>";m=tdcCssEditor._getSettingsPropertyFromCssSettings("display",c);g+='<div class="tdc-property-wrap tdc-display tdc-dropdown-big'+d()+'" data-tdc-for="display">';g=g+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">Display</span></div><div class="tdc-property"><select class="tdc-css-display" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="">');g+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Show"},{value:"none",display:"Hidden"},{value:"inline",display:"Inline"},{value:"inline-block",display:"Inline-block"},{value:"block",display:"Block"},{value:"table",display:"Table"},{value:"inline-table",display:"Inline-table"}],m);g=g+'</select></div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator"></div><div class="tdc-clear-css-properties" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' title="Clear all tab css settings">Clear CSS settings</div>');g+="</div>";tdcSidebarPanel._hook.addAction("panel_css",tdcCssEditor.callbackColorPicker);tdcSidebarPanel._hook.addAction("panel_css",function(){k(".tdc-inherit").each(function(b,e){b=k(e);e=b.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||e.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))b.hide();else{var d=e.data("tdc-for");e={isInherited:!1};d=tdcCssEditor._getSettingsProperty(d,
...
l=b.find(".tdc-css-box-input-margin-left").val().trim(),n=b.find(".tdc-css-box-input-border-top-width").val().trim(),g=b.find(".tdc-css-box-input-border-right-width").val().trim(),m=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),k=b.find(".tdc-css-box-input-border-left-width").val().trim(),q=b.find(".tdc-css-box-input-padding-top").val().trim(),u=b.find(".tdc-css-box-input-padding-right").val().trim(),v=b.find(".tdc-css-box-input-padding-bottom").val().trim(),r=b.find(".tdc-css-box-input-padding-left").val().trim(),
t=b.find(".tdc-css-border-radius").val().trim(),x=b.find(".tdc-css-width").val().trim(),A=b.find(".tdc-css-shadow-size").val().trim(),w=b.find(".tdc-css-shadow-offset-h").val().trim(),z=b.find(".tdc-css-shadow-offset-v").val().trim(),y=b.find(".tdc-css-opacity").val().trim(),B=b.find(".tdc-css-gradient-direction").val().trim(),C=b.find(".tdc-css-z-index").val().trim(),D="";b.find(".tdc-css-order").length&&(D=b.find(".tdc-css-order").val().trim());""!==d&&(c["margin-top"]=d);""!==f&&(c["margin-right"]=
f);""!==h&&(c["margin-bottom"]=h);""!==l&&(c["margin-left"]=l);""!==n&&(c["border-top-width"]=n);""!==g&&(c["border-right-width"]=g);""!==m&&(c["border-bottom-width"]=m);""!==k&&(c["border-left-width"]=k);""!==q&&(c["padding-top"]=q);""!==u&&(c["padding-right"]=u);""!==v&&(c["padding-bottom"]=v);""!==r&&(c["padding-left"]=r);d=b.find(".tdc-css-border-style");f=d.val().trim();""===f||d.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["border-style"]=f);d=b.find(".tdc-css-border-color");
f=d.val().trim();""!==f?c["border-color"]=f:(d=d.data("no_value"),a.isUndefined(d)||1!==d||(c["border-color"]="no_value"));""!==t&&(c["border-radius"]=t);""!==x&&(c.width=x);""!==A&&(c["shadow-size"]=A);t=b.find(".tdc-css-shadow-color");x=t.val().trim();""!==x?c["shadow-color"]=x:(t=t.data("no_value"),a.isUndefined(t)||1!==t||(c["shadow-color"]="no_value"));""!==w&&(c["shadow-offset-h"]=w);""!==z&&(c["shadow-offset-v"]=z);w=b.find(".tdc-css-bg-color");z=w.val().trim();""!==z?c["background-color"]=
...
z=w.val().trim();""===z||w.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["background-position"]=z);""!==y&&(c.opacity=y);y=b.find(".tdc-css-color-1-overlay");w=y.val().trim();""!==w?c["color-1-overlay"]=w:(y=y.data("no_value"),a.isUndefined(y)||1!==y||(c["color-1-overlay"]="no_value"));y=b.find(".tdc-css-color-2-overlay");w=y.val().trim();""!==w?c["color-2-overlay"]=w:(y=y.data("no_value"),a.isUndefined(y)||1!==y||(c["color-2-overlay"]="no_value"));""!==B&&(c["gradient-direction"]=
...
a.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(a.attr("name"),d,tdcSidebar.currentViewportSettings.name))}else if("text"===a.attr("type")){d=a.val().trim();b=a.prev('input[type="range"]');var f=a.data("default_value");if("all"===tdcSidebar.currentViewportSettings.name)""!==d||_.isUndefined(f)||""===f||(d=f,a.val(d));else if(""===d){var h=tdcSidebarPanel.getCurrentResponsiveValue(b.attr("name"),"all");"undefined"===typeof h?_.isUndefined(f)||""===f||(d=f,a.val(d)):(a.val(""),
a.attr("placeholder",h))}b.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(b.attr("name"),d,tdcSidebar.currentViewportSettings.name));"undefined"===typeof h?b.val(d):(b.val(h),c.addClass("tdc-css-inherited"));b=a.prev('input[type="range"]').get(0)}h=b;c=jQuery(h);a=c.data("data-to-save");c=tdcIFrameData.getModel(c.data("model_id"));h.oldValue!==a&&(tdcSidebarController.onUpdate(c,jQuery(h).data("param_name"),h.oldValue,_.escape(a)),h.oldValue=a)});a.on("keyup focus change input",
".tdc-tab-no-design .tdc-property-range_multiple input",function(a){var b=jQuery(this),c=this;if("range"===b.attr("type")){var d=b.closest(".tdc-property").find('input[type="radio"]:checked');b.closest(".tdc-property").find('input[type="text"]').val(b.val());d.data("last_value",b.val())}else if("text"===b.attr("type")){c=b.closest(".tdc-property").find('input[type="range"]');d=b.closest(".tdc-property").find('input[type="radio"]:checked');var f=d.data("default_value"),h=b.val().trim();""!==h||_.isUndefined(f)||
""===f||(h=f,b.val(h));c.val(h);d.data("last_value",h);c=c.get(0)}else if("radio"===b.attr("type")){c=b.closest(".tdc-property").find('input[type="range"]');d=b.closest(".tdc-property").find('input[type="text"]');b.closest(".tdc-property").find('input[type="radio"]:checked');h=b.data("last_value");f=b.data("default_value");var l=b.data("unit");b=c.data("min_"+l);var n=c.data("max_"+l);l=c.data("step_"+l);c.get(0).min=b;c.get(0).max=n;c.get(0).step=l;""===h?(d.val(f),c.val(f)):(d.val(h),c.val(h));
...
f=c.find('input[type="radio"]:checked'),h=c.find('input[type="text"]'),l=d.get(0),n="",g=f.data("default_value"),m=tdcIFrameData.getModel(d.data("model_id")),k=d.data("param_name"),q=window.tdcAdminSettings.mappedShortcodes[m.attributes.tag],u=m="";var v=[];for(var r=0;r<q.params.length;r++)if(k===q.params[r].param_name){r=q.params[r].tdc_values;for(var t in r)r.hasOwnProperty(t)&&(v.push(r[t].unit),""===m||""===u)&&(m=r[t].value,u=r[t].unit);break}f.length&&(n=f.data("unit_value"));if("range"===
b.attr("type"))v=d.val(),h.val(v),f.data("last_value",v),h.val(v),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),v+n,tdcSidebar.currentViewportSettings.name)),c.removeClass("tdc-css-inherited");else if("text"===b.attr("type")){if("input"===a.type||"change"===a.type)return;c.removeClass("tdc-css-inherited");v=h.val().trim();if("all"===tdcSidebar.currentViewportSettings.name)""!==v||_.isUndefined(g)||""===g?(d.val(v),f.data("last_value",v),d.data("data-to-save",
tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),v+n,tdcSidebar.currentViewportSettings.name))):(d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+k,tdcSidebar.currentViewportSettings.name)),d.data("range_value",m),d.data("range_unit",u),d.val(m),n=c.find('input[type="radio"][data-unit_value="'+u+'"]'),q=n.data("unit"),t=d.data("min_"+q),f=d.data("max_"+q),q=d.data("step_"+q),n.prop("checked",!0),l.min=t,l.max=f,l.step=q,l.value=m,n.data("last_value",m),h.val(m));
else if(""===v)if(n=tdcSidebarPanel.getCurrentResponsiveValue(d.attr("name"),"all"),"undefined"===typeof n)d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+k,tdcSidebar.currentViewportSettings.name)),d.data("range_value",m),d.data("range_unit",u),d.val(m),n=c.find('input[type="radio"][data-unit_value="'+u+'"]'),q=n.data("unit"),t=d.data("min_"+q),f=d.data("max_"+q),q=d.data("step_"+q),n.prop("checked",!0),l.min=t,l.max=f,l.step=q,l.value=m,n.data("last_value",m),h.val(m),c.addClass("tdc-css-inherited");
else for(r=0;r<q.params.length;r++){if(k===q.params[r].param_name){v=[];h=[];r=q.params[r].tdc_values;for(t in r)r.hasOwnProperty(t)&&v.push(r[t].unit);for(r=0;r<v.length&&!(h=n.split(v[r]),1<h.length);r++);h.length&&(m=h[0],u=v[r],d.data("range_value",m),d.data("range_unit",u),n=c.find('input[type="radio"][data-unit_value="'+u+'"]'),q=n.data("unit"),t=d.data("min_"+q),f=d.data("max_"+q),q=d.data("step_"+q),n.prop("checked",!0),l.min=t,l.max=f,l.step=q,l.value=m,n.data("last_value",m),c.find('input[type="text"]').val(m));
d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+k,tdcSidebar.currentViewportSettings.name));c.addClass("tdc-css-inherited");break}}else d.val(v),f.data("last_value",v),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),v+n,tdcSidebar.currentViewportSettings.name))}else if("radio"===b.attr("type")){if("input"===a.type)return;k=f.data("last_value");q=f.data("unit");t=d.data("min_"+q);f=d.data("max_"+q);q=d.data("step_"+q);l.min=t;l.max=f;l.step=
q;""===k?(h.val(g),d.val(g),v=g):(h.val(k),d.val(k),v=k);d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),v+n,tdcSidebar.currentViewportSettings.name));c.removeClass("tdc-css-inherited")}n="";c=jQuery(l).parent().find('input[type="radio"]:checked');c.length&&(n=jQuery(c[0]).data("unit_value"));"focusin"===a.type?l.oldValue=l.value+n:(c=jQuery(l),a=c.data("data-to-save"),m=tdcIFrameData.getModel(c.data("model_id")),l.oldValue!==a&&(tdcSidebarController.onUpdate(m,
...
b.removeClass("tdc-flex-row-rev-align-rev"))});a.on("change",".tdc-property-flex_layout_reverse input",function(a){a=jQuery(this);var b=jQuery(".tdc-property-flex_layout .tdc-property-input-radio:checked"),c=jQuery(".tdc-property-flex_horiz_align");"column"===b.val()&&(a.is(":checked")?c.hasClass("tdc-flex-row-rev-align-rev")||c.addClass("tdc-flex-row-rev-align-rev"):c.hasClass("tdc-flex-row-rev-align-rev")&&c.removeClass("tdc-flex-row-rev-align-rev"))});a.on("mousedown",function(a){var b=jQuery("#tdc-sidebar"),
c=jQuery("#tdc-icon-selector"),d=jQuery("#tdc-gradient"),f=jQuery("#tdc-palette"),h=jQuery("#tdc-font-list"),l=jQuery(".tdc-preset-values-list");c.length?c.get(0).contains(a.target)||(c.hide(),b.after(c)):c=tdcSidebar.buildIconSelector();d.length?d.get(0).contains(a.target)||(c=jQuery(a.target),c.hasClass("tdc-gradient-wrap")||(d.hide(),b.after(d))):d=tdcSidebar.buildGradient();f.length?f.get(0).contains(a.target)||(c=jQuery(a.target),c.hasClass("tdc-colorpicker-wrap")||(f.hide(),b.after(f),f.find("input.wp-color-picker").tdPaletteColorPicker("save_color"))):
...
h="tdc-three-column";if(_.has(f,"width"))switch(f.width){case "1/3":h="tdc-one-column";break;case "2/3":h="tdc-two-column"}c.addClass("tdc-dropped-wpeditor");c.html('<iframe id="tdc-iframe-wpeditor" class="'+h+'" src="'+window.tdcAdminSettings.pluginUrl+"/includes/wpeditor.php?wp_path="+window.tdcAdminSettings.ABSPATH+'" scrolling="auto" style="width: 100%; height: 100%" data-model_id="'+b+'" data-mapped_parameter_name="'+d+'"></iframe>');a.show();tdcWindowFrame.setWindowFrame(a)});a.on("click","#tdc-wpeditor .tdc-iframe-close-button",
...
"")}}for(l in e)switch(e=l.split("-"),e.length){case 2:if(!_.has(a,l)){d=e[0];e=!1;for(var n in a)if(d===a[n]&&1===n.split("-").length){e=!0;break}if(!e){var g;for(g in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[g],d)){var m=g;break}_.has(a,m)&&""===a[m]&&window.tdcAdminSettings.globalStyle[m]===d&&(e=!0)}e||delete c[l]}break;case 3:d=e[0];b=e[2];for(g in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[g],d)){m=g;break}e=
...
for(var h=0;h<f.length;h++){var l=!1,n=f[h];if(0===n.param_name.indexOf("tds_")){for(var g in d)if(n.param_name===g){c[g]=d[g];l=!0;break}l||(c[n.param_name]="")}}for(g in d)switch(d=g.split("-"),d.length){case 2:if(!_.has(c,g)){f=d[0];d=!1;for(var m in c)if(f===c[m]&&1===m.split("-").length){d=!0;break}if(!d){var p;for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],f)){var q=p;break}_.has(c,q)&&""===c[q]&&window.tdcAdminSettings.globalStyle[q]===f&&(d=
!0)}d||delete e[g]}break;case 3:f=d[0];l=d[2];for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],f)){q=p;break}d=!1;for(m in c)if(f===c[m]&&m===q+"-"+l){d=!0;break}d||_.has(c,q+"-"+l)&&""===c[q+"-"+l]&&window.tdcAdminSettings.globalStyle[q]===f&&(d=!0);d||delete e[g]}var u=[],v;for(v in window.tdcAdminSettings.listStyles[b])if(v===a){for(h=0;h<window.tdcAdminSettings.listStyles[b][v].length;h++)g=window.tdcAdminSettings.listStyles[b][v][h],_.isArray(g)?
_.map(g,function(a){_.isUndefined(e[a])||(_.isUndefined(u[h])&&(u[h]=[]),u[h].push(e[a]))}):_.isUndefined(e[g])||(_.isArray(e[g])&&e[g].length?u[h]=e[g][0]:u[h]=e[g]);break}return u}},showHideTdcCssEditor:function(a){a=jQuery("#tdc-editor-css");var c=jQuery(this).closest(".tdc-property-wrap"),b=c.find("textarea:first");a.length||tdcSidebar.buildEditorCss();tdcSidebar.$editorTextarea=b;c.next("#tdc-editor-css").length?a.toggle():(c.after(a),a.show(),tdcSidebar.editorCss.getSession().setValue(b.val()))},
...
wp.media.editor.open(c);jQuery(".media-menu .media-menu-item:nth-of-type(2)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(a){if(-1!==a.indexOf("[caption")){var b=/\[caption(.*)\](.*)\[\/caption\]/g.exec(a);3===b.length&&(a=b[2])}var d=jQuery("img",a).attr("src"),f=b="",h="";"undefined"===typeof d?(a=jQuery(a),d=a.attr("src"),b=a.attr("class"),f=a.attr("height"),
h=a.attr("width")):(a=jQuery("img",a),b=a.attr("class"),f=a.attr("height"),h=a.attr("width"));jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_class:b,action:"tdc_ajax_get_image_id"}}).done(function(a,b,e){"success"===b&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(c.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button"),
...
(d=c.params[e].group);b.push(d)}b=_.uniq(b);var f=d="",h=tdcSidebar.getCurrentTabId(),l,n;d+='<div class="tdc-sidebar-header"><div class="tdc-tabs">';var g=n=l="";for(e=0;e<b.length;e++){f=tdcSidebarPanel._fixGroupName(b[e]);var m=tdcUtil.makeSafeForCSS(f);0===e?(l='<a href="#" data-tab-id="td-tab-'+m+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>',n='<a href="#" data-tab-id="td-tab-'+m+'" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>'):
_.isUndefined(h)||h!=="td-tab-"+m?g+='<a href="#" data-tab-id="td-tab-'+m+'" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>':(l=n,g+='<a href="#" data-tab-id="td-tab-'+m+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>')}d=d+(l+g)+"</div>";g=n=l=e="";if(tdcState.isMobileComposer())switch(tdcSidebar.currentViewportSettings.name){case "all":e="selected";break;case "phone":g="selected"}else switch(tdcSidebar.currentViewportSettings.name){case "all":e=
"selected";break;case "landscape":l="selected";break;case "portrait":n="selected";break;case "phone":g="selected"}d+='<div class="tdc-tab-responsive"><div class="tdc-responsive-buttons">';tdcState.isMobileComposer()?d+='<div class="tdc-responsive-all tdc-responsive-tablet-landscape '+e+'" title="Phone landscape"><span class="tdc-tablet-landscape-icon"></span></div>':(d+='<div class="tdc-responsive-all '+e+'" title="Desktop viewport"><span class="tdc-all-icon"></span></div>',"Newspaper"===window.tdcAdminSettings.themeName&&
(d+='<div class="tdc-responsive-tablet-landscape '+l+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div>'),d+='<div class="tdc-responsive-tablet-portrait '+n+'" title="Portrait viewport"><span class="tdc-tablet-portrait-icon"></span></div>');d+='<div class="tdc-responsive-phone '+g+'" title="Phone viewport"><span class="tdc-phone-icon"></span></div></div>';d+="</div>";d+='<div class="tdc-search">';d+='<i class="td-icon-search"></i>';d+='<input type="text" placeholder="Search settings..." />';
d+="</div></div>";d+='<div class="tdc-sidebar-sticky-a"></div>';d+='<div class="tdc-sidebar-sticky-b"></div>';d+='<div class="tdc-tab-content-wrap">';g=n=l="";for(e=0;e<b.length;e++){f=tdcSidebarPanel._fixGroupName(b[e]);m=tdcUtil.makeSafeForCSS(f);f="tdc-tab-no-design";var k=a.get("tag");"css"===m&&(f="tdc-tab-design");0===e?(l='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+m+'">',n='<div class="tdc-tab-content '+f+'" id="td-tab-'+m+'">',m=window.tdcAdminSettings.mappedShortcodes[k].tdc_start_values,
a.unset("presetValues"),_.isUndefined(m)||(m=JSON.parse(window.atob(m)),_.isArray(m)&&1<m.length&&a.set("presetValues",m)),a.has("presetValues")&&(m=a.get("presetValues"),g+=tdcSidebarPanel._addPresetValuesSelector(m,a))):_.isUndefined(h)||h!=="td-tab-"+m?g+='<div class="tdc-tab-content '+f+'" id="td-tab-'+m+'">':(l=n,g+='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+m+'">');g+=tdcSidebarPanel._bindGroupAndGetHtml(b[e],c,a);m=' data-model_id="'+a.cid+'" ';"dev"===window.tdcAdminSettings.deployMode&&
(g+='<div class="tdc-sidebar-row-buttons">',g+='<div class="tdc-sidebar-button tdc-sidebar-shortcode-row" '+m+' title="Get the shortcode of the current row">CONSOLE: shortcode</div>',g+='<div class="tdc-sidebar-button tdc-sidebar-current-styles-settings" '+m+' title="Get the current styles\' settings">CONSOLE: style presets</div>',g+="</div>");g+="</div>"}d=d+(l+g)+"</div>";jQuery(".tdc-inspector .tdc-tabs-wrapper").html(d);jQuery(".tdc-inspector-wrap").addClass("tdc-inspector-active");tdcSidebarPanel._hook.addAction("panel_rendered",
function(){"undefined"===typeof window.tdcResponsiveValues&&(window.tdcResponsiveValues={},"all"===tdcSidebar.currentViewportSettings.name?jQuery(".tdc-tab-content-wrap").removeClass("tdc-viewport-responsive"):jQuery(".tdc-tab-content-wrap").addClass("tdc-viewport-responsive"),jQuery(".tdc-tab-content-wrap .tdc-property-responsive").each(function(){var a=jQuery(this),b=a.find("[data-responsive]"),c=b.attr("name"),d=b.data("responsive");try{var e=window.atob(d);window.tdcResponsiveValues[c]=JSON.parse(e)}catch(x){d=
...
d.addClass("tdc-flex-row-align-rev"),e.find("input").is(":checked")&&c.addClass("tdc-flex-row-rev-align-rev"))}}})();(function(){if("td_woo_products_live_search"===a.get("tag")){var b=jQuery("body .tdc-property-woo_search_version select").val(),c=jQuery("body .tdc-woos-dropdown"),d=jQuery("body .tdc-woos-regular");""===b?d.hide():"regular"===b&&c.hide()}})()}},_bindGroupAndGetHtml:function(a,c,b){var e="",d=b.get("attrs");if("tdc_zone"===b.get("tag"))var f=d.type;for(var h=0;h<c.params.length;h++){var l=
c.params[h].param_name,n=c.params[h].group;if(a===tdcSidebarPanel._defaultGroupName&&_.isEmpty(c.params[h].group)||c.params[h].group===a){if(!_.isUndefined(f)&&(!_.isUndefined(c.params[h].zone_group)&&f!==c.params[h].zone_group||"type"===l))continue;e+=tdcSidebarPanel._bindParamAndGetHtml(c.params[h],b)}if("block_template_id"===l){n=d.block_template_id;_.isEmpty(n)&&(n=window.tdcAdminSettings.globalBlockTemplate);l=window.tdcAdminSettings.mappedBlockTemplates;for(var g=0;g<l[n].params.length;g++)if(a===
tdcSidebarPanel._defaultGroupName&&_.isEmpty(l[n].params[g].group)||l[n].params[g].group===a)e+=tdcSidebarPanel._bindParamAndGetHtml(l[n].params[g],b)}else if(0===l.indexOf("tds_")){var m=l.split("-");g=m[0];var k;2===m.length?k=m[1]:2<m.length&&new tdcNotice.notice('Param "'+l+'" must have up to at most one "-" separator ',!0,!1);l=d[l];_.isEmpty(l)&&(l=window.tdcAdminSettings.globalStyle[g]);m=window.tdcAdminSettings.settingsStyle[g];for(g=0;g<m[l].params.length;g++)if(n==a||_.isUndefined(n)&&a===
tdcSidebarPanel._defaultGroupName){var q=JSON.parse(JSON.stringify(m[l].params[g]));q.param_name=l+"-"+q.param_name;_.isUndefined(k)||(q.param_name+="-"+k);e+=tdcSidebarPanel._bindParamAndGetHtml(q,b)}}}return e},_bindParamAndGetHtml:function(a,c){switch(a.type){case "custom":return tdcSidebarPanel.addCustom(a,c);case "colorpicker":return tdcSidebarPanel.addColorpicker(a,c);case "gradient":return tdcSidebarPanel.addGradient(a,c);case "dropdown":return tdcSidebarPanel.addDropDown(a,c);case "dropdown-responsive":return tdcSidebarPanel.addDropDownResponsive(a,
...
"menu_id"===a.param_name){var b=c.get("attrs");b.menu_id=window.tdcPostSettings.mobileMenuId;c.set("attrs",b)}var e=b=!1;_.has(a,"tdc_dropdown_images")&&""!==a.tdc_dropdown_images&&(b=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(e=!0);var d="",f="",h=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&h.length<=parseInt(a.tdc_min_options))return d;for(var l=0;l<h.length;l++){var k=!1,g="",m="",p=h[l],q=String(tdcSidebarPanel._getParameterCurrentValue(a,c)),u=String(a.value[h[l]]);
_.isObject(a.value[h[l]])&&(k=!0,u=_.values(a.value[h[l]])[0],p=_.keys(a.value[h[l]])[0]);b||e?(0===l&&""===q&&(q=u),q===u&&(g=" checked "),m=_.uniqueId(),q=u,"vc_row"!==c.attributes.tag&&"vc_row_inner"!==c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(q="col_"+q),f+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+m+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+g+' value="'+u+'">',b?(g="",k&&(g="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+
g+'" for="'+m+'" title="'+p+'"><div class="'+q+'"></div></label>'):f+='<label class="tdc-property-input-radio-label" for="'+m+'" title="'+p+'">'+u+"</label>"):(q===u&&(g=' selected="selected" '),"__"===u&&-1!==p.search("--")&&(m=" disabled "),f+="<option "+g+" "+m+' value="'+u+'">'+p+"</option>")}h="";_.has(a,"description")&&""!==a.description&&(h=' title="'+a.description+'" ');d+='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';d+='<div class="tdc-property-title"><span class="tdc-search-data"'+
h+">"+a.heading+"</span></div>";d+='<div class="tdc-property">';b||e?d+=f:(d+="<select "+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'">',d=d+f+"</select>");d=d+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return d+"</div>"},addDropDownResponsive:function(a,c){var b=!1,e=!1;_.has(a,"tdc_dropdown_images")&&""!==a.tdc_dropdown_images&&(b=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(e=!0);var d="",f="",h=Object.keys(a.value);
if(_.has(a,"tdc_min_options")&&h.length<=parseInt(a.tdc_min_options))return d;var l=' data-responsive="" ',k=String(tdcSidebarPanel._getParameterCurrentValue(a,c));try{var g=JSON.parse(window.atob(k));l=' data-responsive="'+k+'" ';"undefined"!==typeof g[tdcSidebar.currentViewportSettings.name]&&(k=g[tdcSidebar.currentViewportSettings.name])}catch(t){}for(g=0;g<h.length;g++){var m=!1,p="",q=h[g],u=String(a.value[h[g]]);_.isObject(a.value[h[g]])&&(m=!0,u=_.values(a.value[h[g]])[0],q=_.keys(a.value[h[g]])[0]);
if(b||e){0===g&&""===k&&(k=u);k===u&&(p=" checked ");var v=_.uniqueId(),r=u;"vc_row"!==c.attributes.tag&&"vc_row_inner"!==c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(r="col_"+r);f+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+v+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+p+' value="'+u+'" '+l+">";b?(p="",m&&(p="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+p+'" for="'+v+'" title="'+q+'"><div class="'+
r+'"></div></label>'):f+='<label class="tdc-property-input-radio-label" for="'+v+'" title="'+q+'">'+u+"</label>"}else k===u&&(p=' selected="selected" '),f+="<option "+p+' value="'+u+'">'+q+"</option>"}h="";_.has(a,"description")&&""!==a.description&&(h=' title="'+a.description+'" ');d+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';d+='<div class="tdc-property-title"><span class="tdc-search-data"'+h+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';
d+='<div class="tdc-property">';b||e?d+=f:(d+="<select "+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+l+h+">",d=d+f+"</select>");d=d+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return d+"</div>"},addCheckBox:function(a,c){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var e="";""!==tdcSidebarPanel._getParameterCurrentValue(a,c)&&(e=" checked ");var d='<div class="'+tdcSidebarPanel._getParameterClasses(a)+
...
JSON.parse(window.atob(g));k=' data-responsive="'+g+'" ';g="undefined"===typeof m[tdcSidebar.currentViewportSettings.name]?"":m[tdcSidebar.currentViewportSettings.name]}catch(p){}m='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';m+='<div class="tdc-property-title"><span class="tdc-search-data"'+b+">"+a.heading+"</span></div>";m=m+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+
...
"",g="",m="",p="",q="",u="",v="",r;for(r in e)e.hasOwnProperty(r)&&(l.push(e[r].unit),""===g||""===k)&&(p=e[r].unit,g=' data-range_unit="'+p+'" ',m=e[r].value,k=' data-range_value="'+m+'" ',q=e[r].range_min,u=e[r].range_max,v=e[r].range_step);if(""!==d){for(var t=[],x=0;x<l.length&&!(t=d.split(l[x]),1<t.length);x++);t.length&&(p=l[x],g=' data-range_unit="'+p+'" ',m=t[0],k=' data-range_value="'+m+'" ')}for(r in e)e.hasOwnProperty(r)&&(d=_.uniqueId(),f+=" data-value_"+r+'="'+e[r].value+'" ',f+=" data-min_"+
r+'="'+e[r].range_min+'" ',f+=" data-max_"+r+'="'+e[r].range_max+'" ',f+=" data-step_"+r+'="'+e[r].range_step+'" ',l=e[r].value,t="",e[r].unit===p&&(l=m,q=e[r].range_min,u=e[r].range_max,v=e[r].range_step,t="checked"),h+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+r+'" data-unit_value="'+e[r].unit+'" type="radio" id="'+d+'" '+t+' data-default_value="'+e[r].value+'" data-last_value="'+l+'"/>',h+='<label for="'+d+'">'+e[r].unit+"</label>");e='<div class="'+tdcSidebarPanel._getParameterClasses(a)+
'">';e+='<div class="tdc-property-title"><span class="tdc-search-data"'+b+">"+a.heading+"</span></div>";e=e+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+k+" "+g+" "+f+' min="'+q+'" max="'+u+'" step="'+v+'" value="'+m+'"/>');e=e+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+h+'</div><input type="text" class="tdc_range_value" value="'+(m+'"/>');
e+="</div>";e+="</div>";e+='<span class="tdc-param-name">'+a.param_name+"</span>";return e+="</div>"},addRangeMultipleResponsive:function(a,c){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var e=a.tdc_values,d=tdcSidebarPanel._getParameterCurrentValue(a,c),f="",h="",l=[],k=' data-responsive="" ',g="",m="",p="",q="",u="",v="",r="",t;for(t in e)e.hasOwnProperty(t)&&(l.push(e[t].unit),""===m||""===g)&&(q=e[t].unit,m=' data-range_unit="'+q+'" ',p=e[t].value,g=
' data-range_value="'+p+'" ',u=e[t].range_min,v=e[t].range_max,r=e[t].range_step);if(""!==d){var x=d;try{var A=JSON.parse(window.atob(d));k=' data-responsive="'+d+'" ';x="undefined"===typeof A[tdcSidebar.currentViewportSettings.name]?"":A[tdcSidebar.currentViewportSettings.name]}catch(w){}if(""!==x){d=[];for(A=0;A<l.length&&!(d=x.split(l[A]),1<d.length);A++);d.length&&(q=l[A],m=' data-range_unit="'+q+'" ',p=d[0],g=' data-range_value="'+p+'" ')}}for(t in e)e.hasOwnProperty(t)&&(l=_.uniqueId(),f+=" data-value_"+
t+'="'+e[t].value+'" ',f+=" data-min_"+t+'="'+e[t].range_min+'" ',f+=" data-max_"+t+'="'+e[t].range_max+'" ',f+=" data-step_"+t+'="'+e[t].range_step+'" ',x=e[t].value,d="",e[t].unit===q&&(x=p,u=e[t].range_min,v=e[t].range_max,r=e[t].range_step,d="checked"),h+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+t+'" data-unit_value="'+e[t].unit+'" type="radio" id="'+l+'" '+d+' data-default_value="'+e[t].value+'" data-last_value="'+x+'"/>',h+='<label for="'+l+'">'+e[t].unit+
"</label>");e='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';e+='<div class="tdc-property-title"><span class="tdc-search-data"'+b+">"+a.heading+"</span></div>";e=e+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+g+" "+m+" "+f+" "+k+' min="'+u+'" max="'+v+'" step="'+r+'" value="'+p+'"/>');e=e+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+
h+'</div><input type="text" class="tdc_range_value" value="'+(p+'"/>');e+="</div>";e+="</div>";e+='<span class="tdc-param-name">'+a.param_name+"</span>";return e+="</div>"},addIconSelector:function(a,c){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var e='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';e+='<div class="tdc-property-title"><span class="tdc-search-data"'+b+">"+a.heading+"</span></div>";e=e+'<div class="tdc-property"><div class="tdc-icon-wrap tdc-no-icon-selected" '+
...
h=window.tdcAdminSettings.mappedShortcodes[e.attributes.tag];e=[];for(var l=d="",k=0;k<h.params.length;k++)if(f===h.params[k].param_name){f=h.params[k].tdc_values;for(var g in f)f.hasOwnProperty(g)&&(e.push(f[g].unit),""===d||""===l)&&(d=f[g].value,l=f[g].unit);break}_.isUndefined(c)?(c=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),"all"),_.isUndefined(c)&&(a.data("range_value",d),a.data("range_unit",l),a.val(d),g=b.find('input[type="radio"][data-unit_value="'+l+'"]'),k=g.data("unit"),
f=a.data("min_"+k),l=a.data("max_"+k),k=a.data("step_"+k),h=a.get(0),g.prop("checked",!0),h.min=f,h.max=l,h.step=k,h.value=d,g.data("last_value",d),b.find('input[type="text"]').val(d)),"all"===tdcSidebar.currentViewportSettings.name?b.removeClass("tdc-css-inherited"):b.addClass("tdc-css-inherited")):b.removeClass("tdc-css-inherited");if(!_.isUndefined(c)){d=[];for(k=0;k<e.length&&!(d=c.split(e[k]),1<d.length);k++);d.length&&(d=d[0],l=e[k],a.data("range_value",d),a.data("range_unit",l),a.val(d),g=
b.find('input[type="radio"][data-unit_value="'+l+'"]'),k=g.data("unit"),f=a.data("min_"+k),l=a.data("max_"+k),k=a.data("step_"+k),h=a.get(0),g.prop("checked",!0),h.min=f,h.max=l,h.step=k,h.value=d,g.data("last_value",d),b.find('input[type="text"]').val(d))}}},showShortcodeFromPath:function(a){if(!_.isUndefined(a)){a=a.toString().split("_");var c;a.forEach(function(a,b){""!==a&&(_.isUndefined(c)?c=tdcIFrameData.tdcTopCollection.at(a):(b=c.get("childCollection"),!_.isUndefined(b)&&b.length>a&&(c=b.at(a))))});
