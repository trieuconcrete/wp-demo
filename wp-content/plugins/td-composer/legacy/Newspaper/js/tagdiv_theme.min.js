...
(function(a){var b=0,c=0,d=0,e=0,f="ontouchstart"in window||0<navigator.msMaxTouchPoints,l="onorientationchange"in window,g=!1,r=!1,u=!1,y=!1,x=!1,C="pointer",E="pointer",R=[],V=[],na=[],X=[],F=[],aa=[],G=[],p=[],A=[],ba=[],ia=[],m={showScrollbar:function(b,c){b.scrollbarHide&&a("."+c).css({opacity:b.scrollbarOpacity,filter:"alpha(opacity:"+100*b.scrollbarOpacity+")"})},hideScrollbar:function(a,b,c,d,e,f,g,l,r,u){if(a.scrollbar&&a.scrollbarHide)for(var h=c;h<c+25;h++)b[b.length]=m.hideScrollbarIntervalTimer(10*
h,d[c],(c+24-h)/24,e,f,g,l,r,u,a)},hideScrollbarInterval:function(b,c,d,f,g,k,l,r,u){e=-1*b/A[r]*(g-k-l-f);m.setSliderOffset("."+d,e);a("."+d).css({opacity:u.scrollbarOpacity*c,filter:"alpha(opacity:"+u.scrollbarOpacity*c*100+")"})},slowScrollHorizontalInterval:function(b,c,d,f,g,k,l,r,u,y,I,O,S,v,B,q,x,n,H){if(H.infiniteSlider){if(d<=-1*A[q]||d<=-1*ba[q]){var h=a(b).width();if(d<=-1*ba[q]){var D=-1*I[0];a(c).each(function(b){m.setSliderOffset(a(c)[b],D+x);b<O.length&&(O[b]=-1*D);D+=B[b]});d+=-1*
O[0];p[q]=-1*O[0]+x;A[q]=p[q]+h-k;G[q]=0}for(;d<=-1*A[q];){var t=0,K=m.getSliderOffset(a(c[0]),"x");a(c).each(function(a){m.getSliderOffset(this,"x")<K&&(K=m.getSliderOffset(this,"x"),t=a)});S=p[q]+h;m.setSliderOffset(a(c)[t],S);p[q]=-1*O[1]+x;A[q]=p[q]+h-k;O.splice(0,1);O.splice(O.length,0,-1*S+x);G[q]++}}if(d>=-1*p[q]||0<=d){h=a(b).width();if(0<d)for(D=-1*I[0],a(c).each(function(b){m.setSliderOffset(a(c)[b],D+x);b<O.length&&(O[b]=-1*D);D+=B[b]}),d-=-1*O[0],p[q]=-1*O[0]+x,A[q]=p[q]+h-k,G[q]=v;0<
-1*O[0]-h+x;){var z=0,N=m.getSliderOffset(a(c[0]),"x");a(c).each(function(a){m.getSliderOffset(this,"x")>N&&(N=m.getSliderOffset(this,"x"),z=a)});S=p[q]-B[z];m.setSliderOffset(a(c)[z],S);O.splice(0,0,-1*S+x);O.splice(O.length-1,1);p[q]=-1*O[0]+x;A[q]=p[q]+h-k;G[q]--;F[q]++}for(;d>-1*p[q];)z=0,N=m.getSliderOffset(a(c[0]),"x"),a(c).each(function(a){m.getSliderOffset(this,"x")>N&&(N=m.getSliderOffset(this,"x"),z=a)}),S=p[q]-B[z],m.setSliderOffset(a(c)[z],S),O.splice(0,0,-1*S+x),O.splice(O.length-1,1),
p[q]=-1*O[0]+x,A[q]=p[q]+h-k,G[q]--}}I=!1;k=m.calcActiveOffset(H,d,O,k,G[q],v,y,q);S=(k+G[q]+v)%v;H.infiniteSlider?S!=aa[q]&&(I=!0):k!=F[q]&&(I=!0);if(I&&(v=new m.args("change",H,b,a(b).children(":eq("+S+")"),S,n),a(b).parent().data("args",v),""!=H.onSlideChange))H.onSlideChange(v);F[q]=k;aa[q]=S;d=Math.floor(d);if(q!=a(b).parent().data("args").data.sliderNumber)return!0;m.setSliderOffset(b,d);H.scrollbar&&(e=Math.floor((-1*d-p[q]+x)/(A[q]-p[q]+x)*(l-r-g)),b=g-u,d>=-1*p[q]+x?(b=g-u- -1*e,m.setSliderOffset(a("."+
f),0)):(d<=-1*A[q]+1&&(b=l-r-u-e),m.setSliderOffset(a("."+f),e)),a("."+f).css({width:b+"px"}))},slowScrollHorizontal:function(b,c,d,f,e,k,g,l,r,u,x,O,y,v,B,q,C,n,H,L,Q){var h=m.getSliderOffset(b,"x");k=[];var D=0,t=25/1024*l;frictionCoefficient=Q.frictionCoefficient;elasticFrictionCoefficient=Q.elasticFrictionCoefficient;snapFrictionCoefficient=Q.snapFrictionCoefficient;e>Q.snapVelocityThreshold&&Q.snapToChildren&&!H?D=1:e<-1*Q.snapVelocityThreshold&&Q.snapToChildren&&!H&&(D=-1);e<-1*t?e=-1*t:e>t&&
(e=t);a(b)[0]!==a(n)[0]&&(D*=-1,e*=-2);n=G[B];if(Q.infiniteSlider)var K=p[B],z=A[B];H=[];t=[];for(var N=0;N<y.length;N++)H[N]=y[N],N<c.length&&(t[N]=m.getSliderOffset(a(c[N]),"x"));for(;1<e||-1>e;){e*=frictionCoefficient;h+=e;(h>-1*p[B]||h<-1*A[B])&&!Q.infiniteSlider&&(e*=elasticFrictionCoefficient,h+=e);if(Q.infiniteSlider){if(h<=-1*z){z=a(b).width();var I=0,E=t[0];for(N=0;N<t.length;N++)t[N]<E&&(E=t[N],I=N);N=K+z;t[I]=N;K=-1*H[1]+L;z=K+z-l;H.splice(0,1);H.splice(H.length,0,-1*N+L);n++}if(h>=-1*
K){z=a(b).width();I=0;E=t[0];for(N=0;N<t.length;N++)t[N]>E&&(E=t[N],I=N);N=K-v[I];t[I]=N;H.splice(0,0,-1*N+L);H.splice(H.length-1,1);K=-1*H[0]+L;z=K+z-l;n--}}k[k.length]=h}t=!1;e=m.calcActiveOffset(Q,h,H,l,n,C,F[B],B);K=(e+n+C)%C;Q.snapToChildren&&(Q.infiniteSlider?K!=aa[B]&&(t=!0):e!=F[B]&&(t=!0),0>D&&!t?(e++,e>=y.length&&!Q.infiniteSlider&&(e=y.length-1)):0<D&&!t&&(e--,0>e&&!Q.infiniteSlider&&(e=0)));if(Q.snapToChildren||(h>-1*p[B]||h<-1*A[B])&&!Q.infiniteSlider){(h>-1*p[B]||h<-1*A[B])&&!Q.infiniteSlider?
k.splice(0,k.length):(k.splice(.1*k.length,k.length),h=0<k.length?k[k.length-1]:h);for(;h<H[e]-.5||h>H[e]+.5;)h=(h-H[e])*snapFrictionCoefficient+H[e],k[k.length]=h;k[k.length]=H[e]}D=1;0!=k.length%2&&(D=0);for(h=0;h<d.length;h++)clearTimeout(d[h]);n=(e+n+C)%C;K=0;for(h=D;h<k.length;h+=2)if(h==D||1<Math.abs(k[h]-K)||h>=k.length-2)K=k[h],d[d.length]=m.slowScrollHorizontalIntervalTimer(10*h,b,c,k[h],f,g,l,r,u,x,e,O,y,q,C,v,B,L,n,Q);K=(e+G[B]+C)%C;""!=Q.onSlideComplete&&1<k.length&&(d[d.length]=m.onSlideCompleteTimer(10*
...
(x=!0,C="move",E="-moz-grabbing"):null!=navigator.userAgent.match("MSIE 7")?y=r=!0:null!=navigator.userAgent.match("MSIE 8")?y=u=!0:null!=navigator.userAgent.match("MSIE 9")&&(y=!0)},has3DTransform:function(){var b=!1,c=a("<div />").css({msTransform:"matrix(1,1,1,1,1,1)",webkitTransform:"matrix(1,1,1,1,1,1)",MozTransform:"matrix(1,1,1,1,1,1)",transform:"matrix(1,1,1,1,1,1)"});""==c.attr("style")?b=!1:x&&21<=parseInt(navigator.userAgent.split("/")[3],10)?b=!1:void 0!=c.attr("style")&&(b=!0);return b},
getSlideNumber:function(a,b,c){return(a-G[b]+c)%c},calcActiveOffset:function(a,b,c,d,e,f,g,l){e=!1;a=[];var h;b>c[0]&&(h=0);b<c[c.length-1]&&(h=f-1);for(f=0;f<c.length;f++)c[f]<=b&&c[f]>b-d&&(e||c[f]==b||(a[a.length]=c[f-1]),a[a.length]=c[f],e=!0);0==a.length&&(a[0]=c[c.length-1]);for(f=e=0;f<a.length;f++)g=Math.abs(b-a[f]),g<d&&(e=a[f],d=g);for(f=0;f<c.length;f++)e==c[f]&&(h=f);return h},changeSlide:function(b,c,d,e,f,g,l,r,u,x,p,y,C,v,B,q,E,n){m.autoSlidePause(v);for(var h=0;h<e.length;h++)clearTimeout(e[h]);
var D=Math.ceil(n.autoSlideTransTimer/10)+1,k=m.getSliderOffset(c,"x"),t=y[b];t-=k;var K=b-(F[v]+G[v]+q)%q;if(n.infiniteSlider){b=(b-G[v]+2*q)%q;h=!1;0==b&&2==q&&(b=q,y[b]=y[b-1]-a(d).eq(0).outerWidth(!0),h=!0);t=y[b];t-=k;var z=[y[b]-a(c).width(),y[b]+a(c).width()];h&&y.splice(y.length-1,1);for(h=0;h<z.length;h++)Math.abs(z[h]-k)<Math.abs(t)&&(t=z[h]-k)}0>t&&-1==K?t+=a(c).width():0<t&&1==K&&(t-=a(c).width());K=[];m.showScrollbar(n,f);for(h=0;h<=D;h++)z=h,z/=D,z--,z=k+t*(Math.pow(z,5)+1),K[K.length]=
z;D=(b+G[v]+q)%q;for(h=k=0;h<K.length;h++){if(0==h||1<Math.abs(K[h]-k)||h>=K.length-2)k=K[h],e[h]=m.slowScrollHorizontalIntervalTimer(10*(h+1),c,d,K[h],f,g,l,r,u,x,b,p,y,B,q,C,v,E,D,n);0==h&&""!=n.onSlideStart&&(t=(F[v]+G[v]+q)%q,n.onSlideStart(new m.args("start",n,c,a(c).children(":eq("+t+")"),t,b)))}k=!1;n.infiniteSlider?D!=aa[v]&&(k=!0):b!=F[v]&&(k=!0);k&&""!=n.onSlideComplete&&(e[e.length]=m.onSlideCompleteTimer(10*(h+1),n,c,a(c).children(":eq("+D+")"),D,v));X[v]=e;m.hideScrollbar(n,e,h,K,f,g,
l,u,x,v);m.autoSlide(c,d,e,f,g,l,r,u,x,p,y,C,v,B,q,E,n)},changeOffset:function(b,c,d,e,f,g,l,r,u,y,x,C,E,v,B,q,R,n){m.autoSlidePause(v);for(var h=0;h<e.length;h++)clearTimeout(e[h]);n.infiniteSlider||(b=b>-1*p[v]+R?-1*p[v]+R:b,b=b<-1*A[v]?-1*A[v]:b);var k=Math.ceil(n.autoSlideTransTimer/10)+1,D=m.getSliderOffset(c,"x");h=(m.calcActiveOffset(n,b,C,l,G,q,F[v],v)+G[v]+q)%q;var t=C.slice();if(n.snapToChildren&&!n.infiniteSlider)b=C[h];else if(n.infiniteSlider&&n.snapToChildren){for(;b>=t[0];)t.splice(0,
0,t[q-1]+a(c).width()),t.splice(q,1);for(;b<=t[q-1];)t.splice(q,0,t[0]-a(c).width()),t.splice(0,1);h=m.calcActiveOffset(n,b,t,l,G,q,F[v],v);b=t[h]}var K=b-D;b=[];m.showScrollbar(n,f);for(t=0;t<=k;t++){var z=t;z/=k;z--;z=D+K*(Math.pow(z,5)+1);b[b.length]=z}k=(h+G[v]+q)%q;for(t=D=0;t<b.length;t++){if(0==t||1<Math.abs(b[t]-D)||t>=b.length-2)D=b[t],e[t]=m.slowScrollHorizontalIntervalTimer(10*(t+1),c,d,b[t],f,g,l,r,u,y,h,x,C,B,q,E,v,R,k,n);0==t&&""!=n.onSlideStart&&(k=(F[v]+G[v]+q)%q,n.onSlideStart(new m.args("start",
n,c,a(c).children(":eq("+k+")"),k,h)))}D=!1;n.infiniteSlider?k!=aa[v]&&(D=!0):h!=F[v]&&(D=!0);D&&""!=n.onSlideComplete&&(e[e.length]=m.onSlideCompleteTimer(10*(t+1),n,c,a(c).children(":eq("+k+")"),k,v));X[v]=e;m.hideScrollbar(n,e,t,b,f,g,l,u,y,v);m.autoSlide(c,d,e,f,g,l,r,u,y,x,C,E,v,B,q,R,n)},autoSlide:function(a,b,c,d,e,f,g,l,r,u,y,x,p,v,C,q,E){if(!V[p].autoSlide)return!1;m.autoSlidePause(p);R[p]=setTimeout(function(){!E.infiniteSlider&&F[p]>y.length-1&&(F[p]-=C);m.changeSlide(F[p]+G[p]+1,a,b,c,
d,e,f,g,l,r,u,y,x,p,v,C,q,E);m.autoSlide(a,b,c,d,e,f,g,l,r,u,y,x,p,v,C,q,E)},E.autoSlideTimer+E.autoSlideTransTimer)},autoSlidePause:function(a){clearTimeout(R[a])},isUnselectable:function(b,c){return""!=c.unselectableSelector&&1==a(b).closest(c.unselectableSelector).length?!0:!1},slowScrollHorizontalIntervalTimer:function(a,b,c,d,e,f,g,l,r,u,y,p,x,v,C,q,E,n,A,F){return setTimeout(function(){m.slowScrollHorizontalInterval(b,c,d,e,f,g,l,r,u,y,p,x,v,C,q,E,n,A,F)},a)},onSlideCompleteTimer:function(a,
...
onSliderLoaded:"",onSliderUpdate:"",onSliderResize:"",onSlideStart:"",onSlideChange:"",onSlideComplete:""},K);void 0==z&&(z=this);return a(z).each(function(g){function D(){m.autoSlidePause(k);xa=a(M).find("a");Ca=a(M).find("[onclick]");qa=a(M).find("*");a(H).css("width","");a(H).css("height","");a(M).css("width","");J=a(M).children().not("script").get();ma=[];T=[];h.responsiveSlides&&a(J).css("width","100%");A[k]=0;w=[];q=a(H).parent().width();L=a(H).outerWidth(!0);h.responsiveSlideContainer&&(L=
a(H).outerWidth(!0)>q?q:a(H).width());a(H).css({position:h.stageCSS.position,top:h.stageCSS.top,left:h.stageCSS.left,overflow:h.stageCSS.overflow,zIndex:h.stageCSS.zIndex,webkitPerspective:1E3,webkitBackfaceVisibility:"hidden",msTouchAction:"pan-y",width:L});a(h.unselectableSelector).css({cursor:"default"});for(var b=0;b<J.length;b++){ma[b]=a(J[b]).width();T[b]=a(J[b]).outerWidth(!0);var c=T[b];h.responsiveSlides&&(T[b]>L?(c=L+-1*(T[b]-ma[b]),ma[b]=c,T[b]=L):c=ma[b],a(J[b]).css({width:c}));a(J[b]).css({overflow:"hidden",
...
(V[k].startAtSlide-1+P)%P,F[k]=V[k].startAtSlide):(V[k].startAtSlide=0>V[k].startAtSlide-1?w.length-1:V[k].startAtSlide,F[k]=V[k].startAtSlide-1),aa[k]=F[k]);p[k]=A[k]+n;a(M).css({position:"relative",cursor:C,webkitPerspective:"0",webkitBackfaceVisibility:"hidden",width:A[k]+"px"});ea=A[k];A[k]=2*A[k]-L+2*n;(fa=ea+n<L||0==L?!0:!1)&&a(M).css({cursor:"default"});ua=a(H).parent().outerHeight(!0);Q=a(H).height();h.responsiveSlideContainer&&(Q=Q>ua?ua:Q);a(H).css({height:Q});m.setSliderOffset(M,w[F[k]]);
if(h.infiniteSlider&&!fa){b=m.getSliderOffset(a(M),"x");for(c=(G[k]+P)%P*-1;0>c;){var d=0,e=m.getSliderOffset(a(J[0]),"x");a(J).each(function(a){m.getSliderOffset(this,"x")<e&&(e=m.getSliderOffset(this,"x"),d=a)});var f=p[k]+ea;m.setSliderOffset(a(J)[d],f);p[k]=-1*w[1]+n;A[k]=p[k]+ea-L;w.splice(0,1);w.splice(w.length,0,-1*f+n);c++}for(;0<-1*w[0]-ea+n&&h.snapSlideCenter&&va;){var g=0,D=m.getSliderOffset(a(J[0]),"x");a(J).each(function(a){m.getSliderOffset(this,"x")>D&&(D=m.getSliderOffset(this,"x"),
g=a)});f=p[k]-T[g];m.setSliderOffset(a(J)[g],f);w.splice(0,0,-1*f+n);w.splice(w.length-1,1);p[k]=-1*w[0]+n;A[k]=p[k]+ea-L;G[k]--;F[k]++}for(;b<=-1*A[k];)d=0,e=m.getSliderOffset(a(J[0]),"x"),a(J).each(function(a){m.getSliderOffset(this,"x")<e&&(e=m.getSliderOffset(this,"x"),d=a)}),f=p[k]+ea,m.setSliderOffset(a(J)[d],f),p[k]=-1*w[1]+n,A[k]=p[k]+ea-L,w.splice(0,1),w.splice(w.length,0,-1*f+n),G[k]++,F[k]--}m.setSliderOffset(M,w[F[k]]);m.updateBackfaceVisibility(J,k,P,h);h.desktopClickDrag||a(M).css({cursor:"default"});
...
"top"==h.scrollbarLocation?a("."+R).css("top","0"):a("."+R).css("bottom","0"),a("."+R+" ."+I).css({borderRadius:h.scrollbarBorderRadius,background:h.scrollbarBackground,height:h.scrollbarHeight,width:B-W+"px",minWidth:h.scrollbarHeight,border:h.scrollbarBorder,webkitPerspective:1E3,webkitBackfaceVisibility:"hidden",position:"relative",opacity:wa,filter:"alpha(opacity:"+100*wa+")",boxShadow:h.scrollbarShadow}),m.setSliderOffset(a("."+R+" ."+I),Math.floor((-1*w[F[k]]-p[k]+n)/(A[k]-p[k]+n)*(v-U-B))),
...
h.slideStartVelocityThreshold||c<-1*h.slideStartVelocityThreshold)ha=!0;if(ha&&!sa){g=m.getSliderOffset(M,"x");var D=a(ka)[0]===a(O)[0]?p[k]:n,l=a(ka)[0]===a(O)[0]?(p[k]-A[k]-n)/(v-U-B):1,t=a(ka)[0]===a(O)[0]?h.scrollbarElasticPullResistance:h.elasticPullResistance,z=h.snapSlideCenter&&a(ka)[0]===a(O)[0]?0:n,q=h.snapSlideCenter&&a(ka)[0]===a(O)[0]?n:0;"touchmove"==b.type&&(Fa!=b.touches.length&&(ja=-1*g+eventX),Fa=b.touches.length);if(h.infiniteSlider){if(g<=-1*A[k]){var N=a(M).width();if(g<=-1*ba[k]){var C=
-1*Y[0];a(J).each(function(b){m.setSliderOffset(a(J)[b],C+n);b<w.length&&(w[b]=-1*C);C+=T[b]});ja-=-1*w[0];p[k]=-1*w[0]+n;A[k]=p[k]+N-L;G[k]=0}else{var E=0,R=m.getSliderOffset(a(J[0]),"x");a(J).each(function(a){m.getSliderOffset(this,"x")<R&&(R=m.getSliderOffset(this,"x"),E=a)});t=p[k]+N;m.setSliderOffset(a(J)[E],t);p[k]=-1*w[1]+n;A[k]=p[k]+N-L;w.splice(0,1);w.splice(w.length,0,-1*t+n);G[k]++}}if(g>=-1*p[k]||0<=g)if(N=a(M).width(),0<=g)for(C=-1*Y[0],a(J).each(function(b){m.setSliderOffset(a(J)[b],
C+n);b<w.length&&(w[b]=-1*C);C+=T[b]}),ja+=-1*w[0],p[k]=-1*w[0]+n,A[k]=p[k]+N-L,G[k]=P;0<-1*w[0]-N+n;){var S=0,Q=m.getSliderOffset(a(J[0]),"x");a(J).each(function(a){m.getSliderOffset(this,"x")>Q&&(Q=m.getSliderOffset(this,"x"),S=a)});t=p[k]-T[S];m.setSliderOffset(a(J)[S],t);w.splice(0,0,-1*t+n);w.splice(w.length-1,1);p[k]=-1*w[0]+n;A[k]=p[k]+N-L;G[k]--;F[k]++}else S=0,Q=m.getSliderOffset(a(J[0]),"x"),a(J).each(function(a){m.getSliderOffset(this,"x")>Q&&(Q=m.getSliderOffset(this,"x"),S=a)}),t=p[k]-
T[S],m.setSliderOffset(a(J)[S],t),w.splice(0,0,-1*t+n),w.splice(w.length-1,1),p[k]=-1*w[0]+n,A[k]=p[k]+N-L,G[k]--}else N=a(M).width(),g>-1*p[k]+n&&(f=(p[k]+-1*(ja-D-eventX+z)*l-D)*t*-1/l),g<-1*A[k]&&(f=(A[k]+q+-1*(ja-D-eventX)*l-D)*t*-1/l);m.setSliderOffset(M,-1*(ja-D-eventX-f)*l-D+q);h.scrollbar&&(m.showScrollbar(h,I),e=Math.floor((ja-eventX-f-p[k]+z)/(A[k]-p[k]+n)*(v-U-B)*l),g=B,0>=e?(g=B-W- -1*e,m.setSliderOffset(a("."+I),0),a("."+I).css({width:g+"px"})):e>=v-U-W-B?(g=v-U-W-e,m.setSliderOffset(a("."+
I),e),a("."+I).css({width:g+"px"})):m.setSliderOffset(a("."+I),e));"touchmove"==b.type&&(Ba=b.touches[0].pageX);b=!1;f=m.calcActiveOffset(h,-1*(ja-eventX-f),w,L,G[k],P,void 0,k);g=(f+G[k]+P)%P;h.infiniteSlider?g!=aa[k]&&(b=!0):f!=F[k]&&(b=!0);if(b){F[k]=f;aa[k]=g;pa=!0;g=new m.args("change",h,M,a(M).children(":eq("+g+")"),g,g);a(H).data("args",g);if(""!=h.onSlideChange)h.onSlideChange(g);m.updateBackfaceVisibility(J,k,P,h)}}});var Ga=a(window);if(u||r)Ga=a(document);a(g).bind("touchcancel.iosSliderEvent touchend.iosSliderEvent",
...
b.bgOverlay||(b.bgOverlay=C("bg").on("click.mfp",function(){b.close()}),b.wrap=C("wrap").attr("tabindex",-1).on("click.mfp",function(a){b._checkIfClose(a.target)&&b.close()}),b.container=C("container",b.wrap));b.contentContainer=C("content");b.st.preloader&&(b.preloader=C("preloader",b.container,b.st.tLoading));f=a.magnificPopup.modules;for(h=0;f.length>h;h++)g=f[h],g=g.charAt(0).toUpperCase()+g.slice(1),b["init"+g].call(b);E("BeforeOpen");b.st.showCloseBtn&&(b.st.closeBtnInside?(x("MarkupParse",
function(a,b,c,d){c.close_replaceWith=R(d.type)}),l+=" mfp-close-btn-in"):b.wrap.append(R()));b.st.alignTop&&(l+=" mfp-align-top");b.fixedContentPos?b.wrap.css({overflow:b.st.overflowY,overflowX:"hidden",overflowY:b.st.overflowY}):b.wrap.css({top:y.scrollTop(),position:"absolute"});(!1===b.st.fixedBgPos||"auto"===b.st.fixedBgPos&&!b.fixedContentPos)&&b.bgOverlay.css({height:e.height(),position:"absolute"});b.st.enableEscapeKey&&e.on("keyup.mfp",function(a){27===a.keyCode&&b.close()});y.on("resize.mfp",
function(){b.updateSize()});b.st.closeOnContentClick||(l+=" mfp-auto-cursor");l&&b.wrap.addClass(l);h=b.wH=y.height();f={};b.fixedContentPos&&b._hasScrollBar(h)&&(g=b._getScrollbarSize())&&(f.marginRight=g);b.fixedContentPos&&(b.isIE7?a("body, html").css("overflow","hidden"):f.overflow="hidden");g=b.st.mainClass;return b.isIE7&&(g+=" mfp-ie7"),g&&b._addClassToMFP(g),b.updateItemHTML(),E("BuildControls"),a("html").css(f),b.bgOverlay.add(b.wrap).prependTo(b.st.prependTo||d),b._lastFocusedEl=document.activeElement,
setTimeout(function(){b.content?(b._addClassToMFP("mfp-ready"),b._setFocus()):b.bgOverlay.addClass("mfp-ready");e.on("focusin.mfp",b._onFocusIn)},16),b.isOpen=!0,b.updateSize(h),E("Open"),c},close:function(){b.isOpen&&(E("BeforeClose"),b.isOpen=!1,b.st.removalDelay&&!b.isLowIE&&b.supportsTransition?(b._addClassToMFP("mfp-removing"),setTimeout(function(){b._close()},b.st.removalDelay)):b._close())},_close:function(){E("Close");var c="mfp-removing mfp-ready ";if(b.bgOverlay.detach(),b.wrap.detach(),
...
[b.currItem?b.currItem.type:"",d]),b.currItem=c,!b.currTemplate[d]){var e=b.st[d]?b.st[d].markup:!1;E("FirstMarkupParse",e);b.currTemplate[d]=e?a(e):!0}f&&f!==c.type&&b.container.removeClass("mfp-"+f+"-holder");e=b["get"+d.charAt(0).toUpperCase()+d.slice(1)](c,b.currTemplate[d]);b.appendContent(e,d);c.preloaded=!0;E("Change",c);f=c.type;b.container.prepend(b.contentContainer);E("AfterChange")},appendContent:function(a,c){(b.content=a)?b.st.showCloseBtn&&b.st.closeBtnInside&&!0===b.currTemplate[c]?
...
b.wrap.removeClass(a)},_hasScrollBar:function(a){return(b.isIE7?e.height():document.body.scrollHeight)>(a||y.height())},_setFocus:function(){(b.st.focus?b.content.find(b.st.focus).eq(0):b.wrap).focus()},_onFocusIn:function(c){return c.target===b.wrap[0]||a.contains(b.wrap[0],c.target)?void 0:(b._setFocus(),!1)},_parseMarkup:function(b,c,d){var e;d.data&&(c=a.extend(d.data,c));E("MarkupParse",[b,c,d]);a.each(c,function(a,c){if(void 0===c||!1===c)return!0;if(e=a.split("_"),1<e.length){if(a=b.find(".mfp-"+
...
cursor:"mfp-ajax-cur",tError:'<a href="%url%">The content</a> could not be loaded.'},proto:{initAjax:function(){b.types.push("ajax");p=b.st.ajax.cursor;x("Close.ajax",A);x("BeforeChange.ajax",A)},getAjax:function(c){p&&d.addClass(p);b.updateStatus("loading");var e=a.extend({url:c.src,success:function(e,f,g){e={data:e,xhr:g};E("ParseAjax",e);b.appendContent(a(e.data),"ajax");c.finished=!0;p&&d.removeClass(p);b._setFocus();setTimeout(function(){b.wrap.addClass("mfp-ready")},16);b.updateStatus("ready");
E("AjaxContentAdded")},error:function(){p&&d.removeClass(p);c.finished=c.loadError=!0;b.updateStatus("error",b.st.ajax.tError.replace("%url%",c.src))}},b.st.ajax.settings);return b.req=a.ajax(e),""}}});var ba,ia=function(c){if(c.data&&void 0!==c.data.title)return c.data.title;var d=b.st.image.titleSrc;if(d){if(a.isFunction(d))return d.call(b,c);if(c.el)return c.el.attr(d)||""}return""};a.magnificPopup.registerModule("image",{options:{markup:'<div class="mfp-figure"><div class="mfp-close"></div><figure><div class="mfp-img"></div><figcaption><div class="mfp-bottom-bar"><div class="mfp-title"></div><div class="mfp-counter"></div></div></figcaption></figure></div>',
...
tCounter:"%curr% of %total%"},proto:{initGallery:function(){var c=b.st.gallery,d=!!a.fn.mfpFastClick;return b.direction=!0,c&&c.enabled?(l+=" mfp-gallery",x("Open.mfp-gallery",function(){c.navigateByImgClick&&b.wrap.on("click.mfp-gallery",".mfp-img",function(){return 1<b.items.length?(b.next(),!1):void 0});e.on("keydown.mfp-gallery",function(a){37===a.keyCode?b.prev():39===a.keyCode&&b.next()})}),x("UpdateStatus.mfp-gallery",function(a,c){c.text&&(c.text=z(c.text,b.currItem.index,b.items.length))}),
...
c():c;1<c&&(x("ImageHasSize.retina",function(a,b){b.img.css({"max-width":b.img[0].naturalWidth/c,width:"100%"})}),x("ElementParse.retina",function(b,d){d.src=a.replaceSrc(d,c)}))}}}});(function(){var b="ontouchstart"in window,c=function(){y.off("touchmove"+d+" touchend"+d)},d=".mfpFastClick";a.fn.mfpFastClick=function(e){return a(this).each(function(){var f,g=a(this);if(b){var l,h,k,m,r,u;g.on("touchstart"+d,function(a){m=!1;u=1;r=a.originalEvent?a.originalEvent.touches[0]:a.touches[0];h=r.clientX;
k=r.clientY;y.on("touchmove"+d,function(a){r=a.originalEvent?a.originalEvent.touches:a.touches;u=r.length;r=r[0];(10<Math.abs(r.clientX-h)||10<Math.abs(r.clientY-k))&&(m=!0,c())}).on("touchend"+d,function(a){c();m||1<u||(f=!0,a.preventDefault(),clearTimeout(l),l=setTimeout(function(){f=!1},1E3),e())})})}g.on("click"+d,function(){f||e()})})};a.fn.destroyMfpFastClick=function(){a(this).off("touchstart"+d+" click"+d);b&&y.off("touchmove"+d+" touchend"+d)}})();V()})(window.jQuery||window.Zepto);
...
var g="placeholder"in b.createElement("input"),r="placeholder"in b.createElement("textarea"),u=c.fn,y=c.valHooks,x=c.propHooks;g&&r?(u=u.placeholder=function(){return this},u.input=u.textarea=!0):(u=u.placeholder=function(){this.filter((g?"textarea":":input")+"[placeholder]").not(".placeholder").bind({"focus.placeholder":e,"blur.placeholder":f}).data("placeholder-enabled",!0).trigger("blur.placeholder");return this},u.input=g,u.textarea=r,u={get:function(a){var b=c(a),d=b.data("placeholder-password");
return d?d[0].value:b.data("placeholder-enabled")&&b.hasClass("placeholder")?"":a.value},set:function(a,b){var d=c(a),g=d.data("placeholder-password");if(g)return g[0].value=b;if(!d.data("placeholder-enabled"))return a.value=b;""==b?(a.value=b,a!=l()&&f.call(a)):d.hasClass("placeholder")?e.call(a,!0,b)||(a.value=b):a.value=b;return d}},g||(y.input=u,x.value=u),r||(y.textarea=u,x.value=u),c(function(){c(b).delegate("form","submit.placeholder",function(){var a=c(".placeholder",this).each(e);setTimeout(function(){a.each(f)},
...
b.hasClass("td-mega-menu"))if(b.parent().hasClass("sf-menu"))if(jQuery.isEmptyObject(c))b.addClass(tdMenu._openMenuClass),b.children("ul").show(),c=b;else{if(b[0]!==c[0]){var u=r=g=0;var y=null;!0===e&&(e=!1,d=setTimeout(function(){a.parent().removeClass(tdMenu._openMenuClass);a.parent().children("ul").hide();b.addClass(tdMenu._openMenuClass);b.children("ul").show();c=b},400));b.on("mousemove",function(f){5<=g?(g=0,y=tdMenu._getMouseAngleDirection(r,u,f.pageX,f.pageY),r=f.pageX,u=f.pageY):(g++,0===
r&&0===u&&(r=f.pageX,u=f.pageY));null!==y&&(85<y||-85>y)&&(a.parent().removeClass(tdMenu._openMenuClass),a.parent().children("ul").hide(),b.addClass(tdMenu._openMenuClass),b.children("ul").show(),b.off("mousemove"),clearTimeout(d),e=!0,c=b)})}}else l=b.siblings(),l.removeClass(tdMenu._openMenuClass),l.find("ul").hide(),l.find("li").removeClass(tdMenu._openMenuClass),b.addClass(tdMenu._openMenuClass),b.children("ul").show(),tdMenu._getSubmenuPosition(b);else b.parent().hasClass("sf-menu")||b.parent().hasClass("top-header-menu")?
jQuery.isEmptyObject(c)||(u=r=g=0,y=null,!0===e&&(e=!1,d=setTimeout(function(){a.parent().removeClass(tdMenu._openMenuClass);a.parent().children("ul").hide();c={}},400)),b.on("mousemove",function(f){5<=g?(g=0,y=tdMenu._getMouseAngleDirection(r,u,f.pageX,f.pageY),r=f.pageX,u=f.pageY):(g++,0===r&&0===u&&(r=f.pageX,u=f.pageY));null!==y&&(85<y||-85>y)&&(a.parent().removeClass(tdMenu._openMenuClass),a.parent().children("ul").hide(),b.off("mousemove"),clearTimeout(d),e=!0,c={})})):(c=b.parent(),l=b.siblings(),
...
"block").css("visibility","visible")},400)};tdInfiniteLoader.addItem(a)});jQuery(window).on("load",function(){tdInfiniteLoader.computeTopDistances()});jQuery().ready(function(){tdInfiniteLoader.computeTopDistances()})})();"use strict";
...
(a.itemImgRetinaSrc=jQuery(b).data("img-retina-url"));tdAnimationStack._initialize_item(a);e.push(a)});!0===d?(tdAnimationStack.log("%c live load items ","background: brown; color: white;"),tdAnimationStack._precompute_items(e,b,c),tdAnimationStack.compute_items(d)):(tdAnimationStack.log("%c preload items ","background: brown; color: white;"),function(){for(var a=!0,d=0;d<e.length;d++)if(!1===f[d].complete){a=!1;break}if(!1===a){var r=(new Date).getTime();tdAnimationStack.log("TIMER - started");var u=
setInterval(function(){var d;if((new Date).getTime()-r>tdAnimationStack.max_waiting_for_init)for(clearInterval(u),d=0;d<e.length;d++)e[d].jqueryObj.removeClass(tdAnimationStack._animation_css_class1),e[d].jqueryObj.addClass(tdAnimationStack._animation_css_class2);else{a=!0;for(d=0;d<e.length;d++)if(!1===f[d].complete){a=!1;break}!0===a&&(clearInterval(u),tdAnimationStack.log("TIMER - stopped"),tdAnimationStack._precompute_items(e,b,c),tdAnimationStack.compute_items(!1))}},100)}else tdAnimationStack._precompute_items(e,
...
100);break;case "css_image":a.jqueryObj.data("complete",!1);tdAnimationStack.log("%c image tag ","background: #3ded97; color: #fff;");if(void 0!==a.itemImgRetinaSrc&&!0===tdAnimationStack._isHighDensity())jQuery("<img/>").attr("src",a.itemImgRetinaSrc).on("load",function(){jQuery(this).remove();a.jqueryObj.data("complete",!0)});else jQuery("<img/>").attr("src",a.itemSrc).on("load",function(){jQuery(this).remove();a.jqueryObj.data("complete",!0)});var e=(new Date).getTime(),f=setInterval(function(){var b=
new Date;!0===a.jqueryObj.data("complete")?(void 0!==a.itemImgRetinaSrc&&!0===tdAnimationStack._isHighDensity()?a.jqueryObj.attr("style",'background-image: url("'+a.itemImgRetinaSrc+'")'):a.jqueryObj.attr("style",'background-image: url("'+a.itemSrc+'")'),clearInterval(f),a.jqueryObj.removeClass(tdAnimationStack._animation_css_class1),a.jqueryObj.addClass(tdAnimationStack._animation_css_class2)):b.getTime()-e>tdAnimationStack.max_waiting_for_init&&(clearInterval(f),void 0!==a.itemImgRetinaSrc&&!0===
...
setTimeout(function(){a.remove()},500);tdAjaxVideoModal._is_modal_open=!1}}})();var tdfAjaxFlickr={};jQuery().ready(function(){tdfAjaxFlickr.init()});
...
jQuery.ajax({type:"POST",url:td_ajax_url,data:{action:"td_ajax_flickr_modal",td_flickr_album_id:c},success:function(a){var b=jQuery.parseJSON(a),c=Object.keys(b).length,e=0;jQuery(".td-flkr-m-loading").remove();jQuery(".td-flkr-m-title").html(d);var r={};Object.keys(b).reverse().forEach(function(a){r[a]=b[a]});jQuery(".td-flkr-m-album-images").show();jQuery.each(r,function(){var a=this.title,b=this.preview_img,d=this.full_img,f=this.thumb_img,g="";e===c-1&&(g="td-flkr-m-img-active",jQuery(".td-flkr-m-main-img").append('<a href="'+
