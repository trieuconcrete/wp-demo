...
<h1 class="wp-heading-inline"><?php echo esc_html(__('Extensions','traveler')); ?></h1>
    ...
    if(!$check_purchase){
        ...
        <div class="error" style="padding: 8px 10px 5px 10px !important; margin-left: 0px; margin-top: 15px;">
            <p class="about-description"><?php printf(__("Please register product before install demo content %s",'traveler'),'<a href="'. admin_url('<?php echo get_admin_url()?>admin.php?page=st_product_reg') .'" target="_blank">Click here.</a>')?></p>
        </div>
        <?php
        return;
    }
