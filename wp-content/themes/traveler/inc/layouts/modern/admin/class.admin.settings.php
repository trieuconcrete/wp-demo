    ...
    public function __bookingSettings() {
        $r = [
            ...
            [
                ...
                'desc' => __('Use this site key in the HTML code your site serves to users. : https://www.google.com/recaptcha/admin', 'traveler'),
                'type' => 'text',
                'section' => 'option_booking',
    ...
    public function __hotelSettings() {
        $r = [
            ...
            [
                ...
                'desc' => esc_html__('OFF: Do not check availability in search results.', 'traveler'),
                'type' => 'on-off',
                'std' => 'off',
                'section' => 'option_hotel',
            ],
