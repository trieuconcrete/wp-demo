    ...
    <div class="bt_ot_gmap_wrap clearfix">
        ...
        <div class="bt_ot_map_field">
            ...
            <div class="" style="padding-left: 10px">
                ...
                <input  type="text" placeholder="<?php _e('Latitude', 'traveler') ?>" id="bt_ot_gmap_input_lat" class="number bt_ot_gmap_input_lat widefat option-tree-ui-input form-control"
                ...
                <input value="<?php echo esc_html($value) ?>" type="text"
                       ...
                       placeholder="<?php _e('Longitude', 'traveler') ?>" id="bt_ot_gmap_input_lng" class="number bt_ot_gmap_input_lng widefat option-tree-ui-input form-control"
                ...
                if($google_api_key === 'on'){ ?>
                    ...
                    <input  value="<?php echo esc_html($value) ?>" type="text"
                           ...
                           placeholder="<?php _e('Zoom Level', 'traveler') ?>" id="bt_ot_gmap_input_zoom" class="number bt_ot_gmap_input_zoom widefat option-tree-ui-input form-control"
                    ...
                    ?>
                        ...
                        <input readonly="readonly" value="<?php echo esc_html($value) ?>" type="text"
                               ...
                               placeholder="<?php _e('Map style', 'traveler') ?>" id="bt_ot_gmap_input_type"  class="bt_ot_gmap_input_type widefat option-tree-ui-input form-control"
