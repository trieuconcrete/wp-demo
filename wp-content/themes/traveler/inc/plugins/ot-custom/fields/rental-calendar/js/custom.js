    ...
    this.initCalendar = function() {
      self.calendar.fullCalendar({
        ...
        select: function(start, end, jsEvent, view) {
          ...
          if (
            (start_date < today && start_year <= today_year) ||
            (end_date < today && end_year <= today_year)
          ) {
            ...
            var check_in = moment(start._d)
              .utcOffset(zone)
              .format("MM/DD/YYYY");
            var check_out = moment(end._d)
              .utcOffset(zone)
              .subtract(1, "day")
              .format("MM/DD/YYYY");
        ...
        eventClick: function(event, element, view) {
          ...
          $(
            "#calendar_status option[value=" + event.status + "]",
            self.form_container
          ).prop("selected");
        },
