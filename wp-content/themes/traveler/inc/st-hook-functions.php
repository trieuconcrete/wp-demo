...
if (! function_exists('st_replace_scripts')) {
    ...
    */
    function st_replace_scripts( $scripts ) {
        st_set_script( $scripts, 'jquery-migrate', get_template_directory_uri() . '/js/compatible-wp/jquery-migrate/jquery-migrate-1.4.1-wp.js', array(), '1.4.1-wp' );
        st_set_script( $scripts, 'jquery-core', get_template_directory_uri() . '/js/compatible-wp/jquery/jquery-1.12.4-wp.js', array(), '1.12.4-wp' );
        st_set_script( $scripts, 'jquery', false, array( 'jquery-core', 'jquery-migrate' ), '1.12.4-wp' );

        // All the jQuery UI stuff comes here.
//            st_set_script( $scripts, '', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/', array(), '' );
        st_set_script( $scripts, 'jquery-ui-core', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/core.min.js', array( 'jquery' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-effects-core', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/effect.min.js', array( 'jquery' ), '1.11.4-wp', 1 );

        st_set_script( $scripts, 'jquery-effects-blind', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/effect-blind.min.js', array( 'jquery-effects-core' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-effects-bounce', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/effect-bounce.min.js', array( 'jquery-effects-core' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-effects-clip', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/effect-clip.min.js', array( 'jquery-effects-core' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-effects-drop', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/effect-drop.min.js', array( 'jquery-effects-core' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-effects-explode', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/effect-explode.min.js', array( 'jquery-effects-core' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-effects-fade', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/effect-fade.min.js', array( 'jquery-effects-core' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-effects-fold', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/effect-fold.min.js', array( 'jquery-effects-core' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-effects-highlight', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/effect-highlight.min.js', array( 'jquery-effects-core' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-effects-puff', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/effect-puff.min.js', array( 'jquery-effects-core', 'jquery-effects-scale' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-effects-pulsate', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/effect-pulsate.min.js', array( 'jquery-effects-core' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-effects-scale', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/effect-scale.min.js', array( 'jquery-effects-core', 'jquery-effects-size' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-effects-shake', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/effect-shake.min.js', array( 'jquery-effects-core' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-effects-size', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/effect-size.min.js', array( 'jquery-effects-core' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-effects-slide', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/effect-slide.min.js', array( 'jquery-effects-core' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-effects-transfer', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/effect-transfer.min.js', array( 'jquery-effects-core' ), '1.11.4-wp', 1 );

        st_set_script( $scripts, 'jquery-ui-accordion', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/accordion.min.js', array( 'jquery-ui-core', 'jquery-ui-widget' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-autocomplete', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/autocomplete.min.js', array( 'jquery-ui-menu', 'wp-a11y' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-button', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/button.min.js', array( 'jquery-ui-core', 'jquery-ui-widget' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-datepicker', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/datepicker.min.js', array( 'jquery-ui-core' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-dialog', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/dialog.min.js', array( 'jquery-ui-resizable', 'jquery-ui-draggable', 'jquery-ui-button', 'jquery-ui-position' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-draggable', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/draggable.min.js', array( 'jquery-ui-mouse' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-droppable', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/droppable.min.js', array( 'jquery-ui-draggable' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-menu', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/menu.min.js', array( 'jquery-ui-core', 'jquery-ui-widget', 'jquery-ui-position' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-mouse', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/mouse.min.js', array( 'jquery-ui-core', 'jquery-ui-widget' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-position', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/position.min.js', array( 'jquery' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-progressbar', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/progressbar.min.js', array( 'jquery-ui-core', 'jquery-ui-widget' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-resizable', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/resizable.min.js', array( 'jquery-ui-mouse' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-selectable', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/selectable.min.js', array( 'jquery-ui-mouse' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-selectmenu', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/selectmenu.min.js', array( 'jquery-ui-menu' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-slider', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/slider.min.js', array( 'jquery-ui-mouse' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-sortable', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/sortable.min.js', array( 'jquery-ui-mouse' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-spinner', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/spinner.min.js', array( 'jquery-ui-button' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-tabs', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/tabs.min.js', array( 'jquery-ui-core', 'jquery-ui-widget' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-tooltip', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/tooltip.min.js', array( 'jquery-ui-core', 'jquery-ui-widget', 'jquery-ui-position' ), '1.11.4-wp', 1 );
        st_set_script( $scripts, 'jquery-ui-widget', get_template_directory_uri() . '/js/compatible-wp/jquery-ui/widget.min.js', array( 'jquery' ), '1.11.4-wp', 1 );

        // This just updates the dependency of `jquery-touch-punch`.
        st_set_script( $scripts, 'jquery-touch-punch', false, array( 'jquery-ui-widget', 'jquery-ui-mouse' ), '0.2.2', 1 );
    }
}
