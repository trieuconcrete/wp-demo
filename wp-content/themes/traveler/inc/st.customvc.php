...
// Add new Param in Row
     ...
     * @since 1.1.5
     * */
    add_filter( 'vc_autocomplete_st_simple_location_st_list_location_2_callback', 'st_vc_include_field_search_location', 10, 1 );
    add_filter( 'vc_autocomplete_st_simple_location_st_list_location_2_render', 'st_autocomplete_st_list_location_2_field_render', 10, 1 );
    function st_autocomplete_st_list_location_2_field_render($value){
