            ...
            self.calendar.fullCalendar({
                ...
                select: function(start, end, jsEvent, view) {
                    ...
                    if ((start_date < today && start_year <= today_year) || (end_date < today && end_year <= today_year)) {
                        ...
                        var check_in = moment(start._d).utcOffset(zone).format(dashboard_params.dateformat_convert.toUpperCase());
                        var check_out = moment(end._d).utcOffset(zone).subtract(1, 'day').format(dashboard_params.dateformat_convert.toUpperCase());
                ...
                eventRender: function(event, element, view) {
                    ...
                    element.bind('click', function(calEvent, jsEvent, view) {
                        ...
                        date = $.fullCalendar.moment(event.start._i).format(dashboard_params.dateformat_convert.toUpperCase());
                        ...
                        if (typeof event.end != 'undefined' && event.end && typeof event.end._i != 'undefined') {
                            ...
                            date = $.fullCalendar.moment(date).format(dashboard_params.dateformat_convert.toUpperCase());
