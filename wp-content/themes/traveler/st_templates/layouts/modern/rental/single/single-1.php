                ...
                <div class="st-flickity st-gallery">
                    ...
                    <div class="shares dropdown">
                        ...
                        <ul class="share-wrapper">
                            ...
                            href="http://pinterest.com/pin/create/bookmarklet/?url=<?php the_permalink() ?>&is_video=false&description=<?php echo strip_tags(get_the_content()) ?>&media=<?php echo get_the_post_thumbnail_url(get_the_ID())?>"
