<?php
    ...
    $iCheck = false;
    if ( empty( $extra_price )  && (!empty($hotel_package) && (!empty($activity_package)) && !empty($car_package) && !empty($flight_package))) {
        return;
    }
...
<div class="form-more-extra-solo">
    <div class="button-extra">
        <a href="#dropdown-more-extra" class="dropdown-more-extra"  data-toggle="collapse" >
            <span><?php echo esc_html__( 'Packages - Extras', 'traveler' ) ?></span>
    ...
    <ul id="dropdown-more-extra" class="dropdown-menu extras collapse"  class="collapse">
        ...
        <?php
        //Package solo
        if (!empty($hotel_package) || (!empty($activity_package)) || !empty($car_package) || !empty($flight_package)) {?>
            <li>
