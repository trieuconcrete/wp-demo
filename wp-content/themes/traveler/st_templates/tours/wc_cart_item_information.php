...
<p class="booking-item-description"><span><?php echo __('Departure date', 'traveler'); ?>: </span><?php echo esc_html(date_i18n( $format , strtotime( $data['check_in'] ) )); ?></p>
<p class="booking-item-description"><span><?php echo __('Return date', 'traveler'); ?>: </span><?php echo esc_html(date_i18n( $format , strtotime( $data['check_out'] ) ) . ($data['starttime'] != '' ? ' - ' . $data['starttime'] : '')); ?></p>
<?php endif; ?>
<?php }else{ ?>
