    ...
    <div class="row item st_partner_payout_item control">
        <div class="col-md-8">
            <div class='form-group form-group-icon-left'>
                ...
                <input  name="st_partner_price" type="number"  placeholder="<?php _e("Amount",'traveler') ?>" class="form-control" value="<?php echo esc_attr(STInput::request('st_partner_price',$price_min)) ?>">
