            ...
            <div class="col-md-8">
                <div class="st-notice-success">
                    ...
                    <div class="title-admin">
                        <p class="st-admin-success"><?php $userdata = get_userdata( $get_order_by_token->partner );echo$userdata->user_login; echo ', ';?> <span><?php echo __('your payment was successful!' , 'traveler' );?></span></p>
                        <p class="st-text">
                    ...
                    <?php elseif( $get_order_by_token->status === 'canceled' ): ?>
                        ...
                        <div class="title-admin">
                            <p class="st-admin-success"><?php $userdata = get_userdata( $get_order_by_token->partner );echo$userdata->user_login; echo ', ';  echo __('Your payment was not successful!' , 'traveler' );?></p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
