...
jQuery(document).ready(function($) {
    ...
    $('.form-extra-field').each(function () {
        ...
        $('input[name="group_adults"]', parent).change(function () {
        ...
        $('input[name="group_children"]', parent).change(function () {
    ...
    $('.form-extra-field').each(function () {
        ...
        $('input[name="adults"]', parent).change(function () {
            var adults = parseInt($(this).val());
            var html = adults;
            if (typeof adults == 'number') {
                if (adults < 2) {
        ...
        $('input[name="children"]', parent).change(function () {
            var children = parseInt($(this).val());
            var html = children;
            if (typeof children == 'number') {
                if (children < 2) {
